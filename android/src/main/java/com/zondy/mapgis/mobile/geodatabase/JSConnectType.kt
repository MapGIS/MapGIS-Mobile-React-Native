 ...
 */
class JSConnectType(context: ReactApplicationContext?) : ReactContextBaseJavaModule(context) {
  ...
  companion object {
    private const val REACT_CLASS = "JSConnectType"
  }
}
